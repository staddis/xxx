...
[task_local]
#京喜工厂
10 3-23 * * * jd_dreamFactory.js, tag=京喜工厂, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "10 3-23 * * *" script-path=jd_dreamFactory.js,tag=京喜工厂
...
$.tuanIds = [fDG2FKL9Z5SW7kre5evcsQ==];
$.appId = 10001;
if ($.isNode()) {
