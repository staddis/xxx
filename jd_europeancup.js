...
55 59 9  * * ? https://raw.githubusercontent.com/Wenmoux/scripts/wen/jd/jd_europeancup.js, tag=欧洲狂欢杯, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
*/
const $ = new Env( '狂欢欧洲杯' );
//Node.js用户请在jdCookie.js处填写京东ck;
const jdCookieNode = $.isNode() ? require( './jdCookie.js' ) : '';
cupExid = $.isNode() ? ( process.env.Cupexid ? process.env.Cupexid : 38 ) : ( $.getdata( "Cupexid" ) ? $.getdata( "Cupexid" ) : 38 ) || 38;
...
$.shareuuid = "4c37a37d31b94b138fefcaf037e719a5" //俺的助力码 
!( async () => {
    if ( !cookiesArr[ 0 ] ) {
